...
private static byte[] mate1(byte[] b1, byte[] b2) {
    ...
    private GameAction harassPlayer1(){
    	Player one = getPlayer(1);
    	return harassPlayer(one);
	}
    
    private GameAction harassPlayer2(){
    	Player two = getPlayer(2);
    	return harassPlayer(two);
	}
    private GameAction HarassPlayer3(){
    	rePlayer three = getPlayer(3);
    	return harassPlayer(three);
	}
