...
public class GameAction {
	public static enum Event {
		CONTINUE_MOVE, ACTION_ATTACK, ACTION_CHECK_ATTACK, BUILD_CITY, BUILD_WORKER, BUILD_POWERPLANT,
		BUILD_FORTIFICATION, ACTION_DESTROY_SELF, ACTION_FORTIFY, BUILD_MINE, END_TURN, ACTION_MOVE, 
		ACTION_ATTACK_MOVE, ACTION_CAPTURE_TARGET, ACTION_DESTROY_TARGET, BUILD_ANTIAIR, BUILD_AIR, BUILD_TANK,
		NULL_ACTION
	}
	...
	public static enum OneAgentEvent {
		CONTINUE_MOVE, BUILD_CITY, BUILD_WORKER, BUILD_ANTIAIR, BUILD_AIR, BUILD_TANK, BUILD_POWERPLANT,
		BUILD_FORTIFICATION, ACTION_DESTROY_SELF,
